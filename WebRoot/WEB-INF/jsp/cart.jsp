...
<div class="container cart">
	<s:if test="#session.cart.cartItems.size()>0">
				...
				<table>
					...
					<s:iterator value="#session.cart.cartItems" var="cartItem">
						<tr>
							...
							<td>
								<a href="${pageContext.request.contextPath}/cart_deletecart?pid=<s:property value="#cartItem.product.pid"/>" class="delete">删除</a>
							</td>
						</tr>
					</s:iterator>
				</tbody></table>
		...
		<s:else>
			<div class="span24">
			<div class="step step1">
			<h2 ><font color="red">亲！您还没有购物哦！请先去购物！！</font> 	</h2>
			</div>
		</div>
		</s:else>
	</div>
