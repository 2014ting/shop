...
<script type="text/javascript">
		...
		function checkForm(){
			...
			if(repassword!=password){
				$("#repasswordspan").text("两次输入的密码不一致");
				return false;
			}
		}
		//对用户名是否存在的检验
		function checkusername(){
			...
			var ajax = create();
			var method ="get";
			var url = "${pageContext.request.contextPath}/user_checkusername?username="+username;
		...
		<div class="span24">
			<div class="wrap">
				<div class="main clearfix">
					<div class="title">
						<strong>会员注册</strong>USER REGISTER<s:actionmessage />
					</div>
					<form id="registerForm" action="${pageContext.request.contextPath}/user_regist" method="post" novalidate="novalidate" onsubmit="return checkForm();">
						...
						<table>
							...
							<tr>
								...
								<td>
									<input type="text" id="email" name="email" class="text" maxlength="200"><br/>
								 <span><s:fielderror fieldName="email"/></span>
									...
									<tr>
										...
										<td>
												<input type="text" name="name" class="text" maxlength="200"><br/>
								 <span><s:fielderror fieldName="name"/></span>
									...
									<tr>
										...
										<td>
												<input type="text" name="addr" class="text" maxlength="200"><br/>
								...
								<tr>
									...
									<td>
										<span class="fieldSet">
											<input type="text" id="checkImg" name="checkcode" class="text captcha" maxlength="4" autocomplete="off"><img id="captchaImage" class="captchaImage" src="${pageContext.request.contextPath}/checkImg" onclick="change()" title="点击更换验证码">
										</span>
									</td>
								</tr>
							<tr>
