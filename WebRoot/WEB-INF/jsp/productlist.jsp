...
<div class="container productList">
		<div class="span6">
			<div class="hotProductCategory">
				<s:iterator value="#session.catelist" var="c">
						<dl>
							<dt>
		...
		<div class="span18 last">
			...
			<form id="productForm" action="${pageContext.request.contextPath}/product_findBypagecid/>" method="get">
				...
				<div id="result" class="result table clearfix">
						...
						<s:iterator value="pageBean.list" var="p">
								<li>
										<a href="${pageContext.request.contextPath}/product_findByid?pid=<s:property value="#p.pid"/>">
	...
	<div class="pagination">
			...
			<s:if test="cid != null">
				...
				<s:iterator var="i" begin="1" end="pageBean.totalpage">
					...
					<!-- 不是当前页 -->
						<a href="${pageContext.request.contextPath}/product_findBycid?cid=<s:property value="cid"/>&&page=<s:property value="#i"/>">	<span ><s:property value="#i"/></span></a>
					
					</s:if>
					<s:else>
						<a href="${pageContext.request.contextPath}/product_findBycid?cid=<s:property value="cid"/>&&page=<s:property value="#i"/>"><span class="currentPage"><s:property value="#i"/></span></a>
					</s:else>
				</s:iterator> 
			...
			<s:if test="csid != null">
				...
				<s:iterator var="i" begin="1" end="pageBean.totalpage">
					<s:if test="pageBean.page!=#i">
					<!-- 不是当前页 -->
						<a href="${pageContext.request.contextPath}/product_findBycsid?csid=<s:property value="csid"/>&&page=<s:property value="#i"/>">	<span ><s:property value="#i"/></span></a>
					
					</s:if>
					<s:else>
						<a href="${pageContext.request.contextPath}/product_findBycsid?csid=<s:property value="csid"/>&&page=<s:property value="#i"/>"><span class="currentPage"><s:property value="#i"/></span></a>
					</s:else>
				</s:iterator> 
