...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategorySecond_update?csid=<s:property value="model.csid"/>" method="post" enctype="multipart/form-data">
