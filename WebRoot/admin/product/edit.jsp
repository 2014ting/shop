...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminProduct_update" method="post" enctype="multipart/form-data">
			...
			<table cellSpacing="1" cellPadding="5" width="100%" align="center" bgColor="#eeeeee" style="border: 1px solid #8ba7e3" border="0">
					...
					<select>
						<s:iterator var="cs" value="cslist">
							<s:if test="#cs.csid == model.categorySecond.csid">
								<option selected="selected"><s:property value="#cs.csname"/> </option>
							</s:if>
							<s:else>
								<option><s:property value="#cs.csname"/> </option>
							</s:else>
				...
				<tr>
					...
					<td class="ta_01" bgColor="#ffffff" colspan="3">
						<textarea rows="10" cols="10" name="pdesc" ><s:property value="model.pdesc"/></textarea>
					</td>
				</tr>
