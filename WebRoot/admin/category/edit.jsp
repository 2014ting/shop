...
<HTML>
	...
	<body>
		<form id="userAction_save_do" name="Form1" action="${pageContext.request.contextPath}/adminCategory_update?cid=<s:property value="model.cid"/>" method="post" enctype="multipart/form-data">
